...
public class GeoWeeklyBoardVO {
    ...
    @Schema(description = "露出率折线（横轴=周，系列=平台）")
    private List<GeoChartPointVO> mentionChart = new ArrayList<>();

    @Schema(description = "首位露出率折线（横轴=周，系列=平台）")
    ...
    public static class GeoWeeklyRowVO {
        ...
        @Schema(description = "露出率环比（百分点）", example = "1.20", nullable = true)
        private Double mentionRateMom;

        @Schema(description = "露出率同比（百分点）", example = "-0.80", nullable = true)
